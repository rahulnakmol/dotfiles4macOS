...
general CLI and productivity foundation with only Claude Desktop and Amp as
...
TF Work adds Claude Desktop to Edge/Teams (30 minutes); Code uses Amp with
Chrome/Ghostty (45 minutes). Zen provides Claude/Obsidian as a non-quitting
...
folders and custom actions. TF has four presets; FDE preserves seven exported
...
and guide native Amp and Session focus-timer installation. Homebrew's session
