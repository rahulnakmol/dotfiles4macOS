...
Use this reference with the **FDE Alfred profile**. For installation, see the [Alfred guide](../guides/alfred.md) or [FDE profile guide](../guides/profiles/fde.md). For Raycast, use its [own shortcuts](raycast-hotkeys.md).
